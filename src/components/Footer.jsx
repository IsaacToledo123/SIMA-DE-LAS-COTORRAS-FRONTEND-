...
const Footer = () => {
  ...
  const enviarCorreo = (event) => {
    ...
    const mailtoLink = `mailto:${"simadelascotorrasoficial@gmail.com"}?subject=${"Información del sitio..."}&body=${"Mensaje aquí.."}`;
    ...
    <footer className="bg-gray-700 text-white py-1">
      <div className="container mx-auto text-center">
        ...
        <div className='flex justify-center items-center py-5'>
          <div>
            <a href="https://es-la.facebook.com/simadelascotorrasoficial/">
