            ...
            <div>
                  <div className="h-screen grid">
                        ...
                        >
                              ...
                              <div className="pt-10 grid sm:grid-cols-2 grid-cols-1 pb-24">

                                    {/* Sección de Imágenes */}
                                    <div className="w-full md:w-2/3 h-full mx-auto">

                                          <h1 className="text-3xl font-thin text-center mb-10">Fotografía:</h1>
                                    ...
                                    <div className="px-10 md:text-xl text-lg text-center md:border-l-2 md:pt-0 pt-10">

                                          <h1 className="text-3xl font-thin text-center md:pt-0">Descripción:</h1>
